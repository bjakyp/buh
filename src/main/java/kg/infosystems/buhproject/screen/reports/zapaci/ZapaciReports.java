package kg.infosystems.buhproject.screen.reports.zapaci;
...
@UiController("ZapaciReports")
@UiDescriptor("zapaci-reports.xml")
public class ZapaciReports extends Screen {
    @Inject
    ...
    public void onInit(InitEvent event) {
        reportField.setOptionsList(dataManager.load(Report.class)
            .query("select r from report_Report r where r.group.code = 'ZapasiReports'").list());
    }
