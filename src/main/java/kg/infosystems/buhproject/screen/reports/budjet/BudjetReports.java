package kg.infosystems.buhproject.screen.reports.budjet;
...
@UiController("BudjetReports")
@UiDescriptor("budjet.xml")
public class BudjetReports extends Screen {
    @Inject
    ...
    public void onInit(InitEvent event) {
        reportField.setOptionsList(dataManager.load(Report.class)
            .query("select r from report_Report r where r.group.code = 'BudgetReports'").list());
    }
