package kg.infosystems.buhproject.screen.reports.bankikassa;
...
@UiController("BankIKassaReports")
@UiDescriptor("bank-i-kassa-reports.xml")
public class BankIKassaReports extends Screen {
    @Inject
    ...
    public void onInit(InitEvent event) {
        reportField.setOptionsList(dataManager.load(Report.class)
            .query("select r from report_Report r where r.group.code = 'BankIKassaReports'").list());
    }
