package kg.infosystems.buhproject.screen.reports.zarplataikadry;
...
@UiController("ZarplataIKadryReports")
@UiDescriptor("zarplata-i-kadry-reports.xml")
public class ZarplataIKadryReports extends Screen {
    @Inject
    ...
    public void onInit(InitEvent event) {
        reportField.setOptionsList(dataManager.load(Report.class)
            .query("select r from report_Report r where r.group.code = 'ZarplataIKadryReports'").list());
    }
