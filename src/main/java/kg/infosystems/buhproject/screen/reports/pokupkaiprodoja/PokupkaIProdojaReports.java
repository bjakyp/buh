package kg.infosystems.buhproject.screen.reports.pokupkaiprodoja;
...
@UiController("PokupkaIProdojaReports")
@UiDescriptor("pokupka-i-prodoja-reports.xml")
public class PokupkaIProdojaReports extends Screen {
    @Inject
    ...
    public void onInit(InitEvent event) {
        reportField.setOptionsList(dataManager.load(Report.class)
            .query("select r from report_Report r where r.group.code = 'PokupkaIProdajaReports'").list());
    }
