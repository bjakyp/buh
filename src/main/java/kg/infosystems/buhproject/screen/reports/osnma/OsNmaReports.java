package kg.infosystems.buhproject.screen.reports.osnma;
...
@UiController("OsNmaReports")
@UiDescriptor("os-nma-reports.xml")
public class OsNmaReports extends Screen {
    @Inject
    ...
    public void onInit(InitEvent event) {
        reportField.setOptionsList(dataManager.load(Report.class)
            .query("select r from report_Report r where r.group.code = 'OsINmaReports'").list());
    }
