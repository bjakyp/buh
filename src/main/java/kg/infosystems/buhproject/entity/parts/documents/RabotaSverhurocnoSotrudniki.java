...
@JmixEntity
@Entity
@Table(name = "RabotaSverhurocnoSotrudniki", schema = "parts_documents")
@Getter
@Setter
public class RabotaSverhurocnoSotrudniki {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.documents.RabotaSverhurocno part;

    @Column(name = "DATA_VYHODA")
    private LocalDateTime dataVyhoda;
    ...
    @NotNull
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "VID_RASCETA_RAZMERA_ID", nullable = false)
