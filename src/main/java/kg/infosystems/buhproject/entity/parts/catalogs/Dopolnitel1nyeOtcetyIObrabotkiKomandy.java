...
@JmixEntity
@Entity
@Table(name = "Dopolnitel1nyeOtcetyIObrabotkiKomandy", schema = "parts_catalogs")
@Getter
@Setter
public class Dopolnitel1nyeOtcetyIObrabotkiKomandy {
	...
	@Column(name = "MODIFIKATOR", length = 256)
    private String modifikator;

	@Column(name = "REGLAMENTNOE_ZADANIE_GUID")
    private UUID reglamentnoeZadanieGUID;

	@Column(name = "SKRYT1")
    private Boolean skryt1;

	@Lob
	@Column(name = "ZAMENAEMYE_KOMANDY")
    private String zamenaemyeKomandy;
