...
@JmixEntity
@Entity
@Table(name = "PredopredelennyeVariantyOtcetovRassirenijPredstavlenia", schema = "parts_catalogs")
@Getter
@Setter
public class PredopredelennyeVariantyOtcetovRassirenijPredstavlenia {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.PredopredelennyeVariantyOtcetovRassirenij part;
