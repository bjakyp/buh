...
@JmixEntity
@Entity
@Table(name = "FiziceskieLicaPrisoedinennyeFajlySertifikatySifrovania", schema = "parts_catalogs")
@Getter
@Setter
public class FiziceskieLicaPrisoedinennyeFajlySertifikatySifrovania {
