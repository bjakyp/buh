...
@JmixEntity
@Entity
@Table(name = "KontragentyDopolnitel1nyeRekvizity", schema = "parts_catalogs")
@Getter
@Setter
public class KontragentyDopolnitel1nyeRekvizity {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.Kontragenty part;
