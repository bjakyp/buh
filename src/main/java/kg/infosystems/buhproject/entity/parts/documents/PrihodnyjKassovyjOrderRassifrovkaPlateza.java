...
@JmixEntity
@Entity
@Table(name = "PrihodnyjKassovyjOrderRassifrovkaPlateza", schema = "parts_documents")
@Getter
@Setter
public class PrihodnyjKassovyjOrderRassifrovkaPlateza {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.PrihodnyjKassovyjOrder part;
