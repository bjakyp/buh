...
@JmixEntity
@Entity
@Table(name = "PredopredelennyeVariantyOtcetovRazmesenie", schema = "parts_catalogs")
@Getter
@Setter
public class PredopredelennyeVariantyOtcetovRazmesenie {
    ...
    private kg.infosystems.buhproject.entity.catalogs.IdentifikatoryOb2ektovMetadannyh podsistema;
