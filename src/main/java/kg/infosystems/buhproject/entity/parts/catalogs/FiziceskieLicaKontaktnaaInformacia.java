...
@JmixEntity
@Entity
@Table(name = "FiziceskieLicaKontaktnaaInformacia", schema = "parts_catalogs")
@Getter
@Setter
public class FiziceskieLicaKontaktnaaInformacia {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.FiziceskieLica part;
