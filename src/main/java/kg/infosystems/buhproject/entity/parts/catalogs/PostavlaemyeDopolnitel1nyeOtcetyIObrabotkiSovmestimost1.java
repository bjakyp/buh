...
@JmixEntity
@Entity
@Table(name = "PostavlaemyeDopolnitel1nyeOtcetyIObrabotkiSovmestimost1", schema = "parts_catalogs")
@Getter
@Setter
public class PostavlaemyeDopolnitel1nyeOtcetyIObrabotkiSovmestimost1 {
