...
@JmixEntity
@Entity
@Table(name = "NastrojkiRassifrovkiMemorial1nogoOrdera9SobytiaPeredaci", schema = "parts_catalogs")
@Getter
@Setter
public class NastrojkiRassifrovkiMemorial1nogoOrdera9SobytiaPeredaci {
