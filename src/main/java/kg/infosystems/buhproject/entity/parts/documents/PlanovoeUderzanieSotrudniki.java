...
@JmixEntity
@Entity
@Table(name = "PlanovoeUderzanieSotrudniki", schema = "parts_documents")
@Getter
@Setter
public class PlanovoeUderzanieSotrudniki {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.PlanovoeUderzanie part;
