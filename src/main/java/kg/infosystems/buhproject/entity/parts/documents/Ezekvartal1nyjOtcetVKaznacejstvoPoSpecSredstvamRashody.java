...
@JmixEntity
@Entity
@Table(name = "Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvamRashody", schema = "parts_documents")
@Getter
@Setter
public class Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvamRashody {
