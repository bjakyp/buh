...
@JmixEntity
@Entity
@Table(name = "VozvratOSINMAPostavsikuNMA", schema = "parts_documents")
@Getter
@Setter
public class VozvratOSINMAPostavsikuNMA {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.VozvratOSINMAPostavsiku part;
