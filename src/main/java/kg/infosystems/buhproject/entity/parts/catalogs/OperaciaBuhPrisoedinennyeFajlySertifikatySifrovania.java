...
@JmixEntity
@Entity
@Table(name = "OperaciaBuhPrisoedinennyeFajlySertifikatySifrovania", schema = "parts_catalogs")
@Getter
@Setter
public class OperaciaBuhPrisoedinennyeFajlySertifikatySifrovania {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.OperaciaBuhPrisoedinennyeFajly part;
