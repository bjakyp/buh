...
@JmixEntity
@Entity
@Table(name = "ProfiliGruppDostupaVidyDostupa", schema = "parts_catalogs")
@Getter
@Setter
public class ProfiliGruppDostupaVidyDostupa {
	...
	@Column(name = "PREDUSTANOVLENNYJ")
    private Boolean predustanovlennyj;
