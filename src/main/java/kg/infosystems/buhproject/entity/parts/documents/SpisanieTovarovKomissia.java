...
@JmixEntity
@Entity
@Table(name = "SpisanieTovarovKomissia", schema = "parts_documents")
@Getter
@Setter
public class SpisanieTovarovKomissia {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.SpisanieTovarov part;
