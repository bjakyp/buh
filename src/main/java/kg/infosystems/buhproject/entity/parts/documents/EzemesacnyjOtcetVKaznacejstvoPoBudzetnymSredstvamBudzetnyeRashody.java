...
@JmixEntity
@Entity
@Table(name = "EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvamBudzetnyeRashody", schema = "parts_documents")
@Getter
@Setter
public class EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvamBudzetnyeRashody {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.documents.EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvam part;
	...
	@Column(name = "FINANSIROVANIE_ZA_PREDYDUSIJ_PERIOD", precision = 15, scale = 2)
    private BigDecimal finansirovanieZaPredydusijPeriod;

	@Column(name = "FINANSIROVANIE_ZA_OTCETNYJ_PERIOD", precision = 15, scale = 2)
    private BigDecimal finansirovanieZaOtcetnyjPeriod;

	@Column(name = "FINANSIROVANIE_S_NACALA_GODA", precision = 15, scale = 2)
    private BigDecimal finansirovanieSNacalaGoda;
