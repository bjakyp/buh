...
@JmixEntity
@Entity
@Table(name = "NomenklaturaDopolnitel1nyeRekvizity", schema = "parts_catalogs")
@Getter
@Setter
public class NomenklaturaDopolnitel1nyeRekvizity {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.Nomenklatura part;
