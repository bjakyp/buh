...
@JmixEntity
@Entity
@Table(name = "PostavlaemyeDopolnitel1nyeOtcetyIObrabotkiRazresenia", schema = "parts_catalogs")
@Getter
@Setter
public class PostavlaemyeDopolnitel1nyeOtcetyIObrabotkiRazresenia {
