...
@JmixEntity
@Entity
@Table(name = "GruppyDostupaZnaceniaDostupa", schema = "parts_catalogs")
@Getter
@Setter
public class GruppyDostupaZnaceniaDostupa {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.GruppyDostupa part;
