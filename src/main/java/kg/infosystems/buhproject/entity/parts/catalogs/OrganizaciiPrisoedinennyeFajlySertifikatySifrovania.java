...
@JmixEntity
@Entity
@Table(name = "OrganizaciiPrisoedinennyeFajlySertifikatySifrovania", schema = "parts_catalogs")
@Getter
@Setter
public class OrganizaciiPrisoedinennyeFajlySertifikatySifrovania {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.OrganizaciiPrisoedinennyeFajly part;
