...
@JmixEntity
@Entity
@Table(name = "NaboryDopolnitel1nyhRekvizitovISvedenijDopolnitel1nyeRekvizity", schema = "parts_catalogs")
@Getter
@Setter
public class NaboryDopolnitel1nyhRekvizitovISvedenijDopolnitel1nyeRekvizity {
