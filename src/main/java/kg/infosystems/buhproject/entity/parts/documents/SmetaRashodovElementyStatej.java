...
@JmixEntity
@Entity
@Table(name = "SmetaRashodovElementyStatej", schema = "parts_documents")
@Getter
@Setter
public class SmetaRashodovElementyStatej {
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "GRUPPA_STAT1I_ID")
	private kg.infosystems.buhproject.entity.catalogs.Stat1iDohodovIRashodov gruppaStat1i;
