...
@JmixEntity
@Entity
@Table(name = "VozvratTovarovPostavsikuTovary", schema = "parts_documents")
@Getter
@Setter
public class VozvratTovarovPostavsikuTovary {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.VozvratTovarovPostavsiku part;
