...
@JmixEntity
@Entity
@Table(name = "PapkiFajlovDopolnitel1nyeRekvizity", schema = "parts_catalogs")
@Getter
@Setter
public class PapkiFajlovDopolnitel1nyeRekvizity {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.PapkiFajlov part;
