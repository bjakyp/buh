...
@JmixEntity
@Entity
@Table(name = "ModernizaciaOSParametryOb2ekta", schema = "parts_documents")
@Getter
@Setter
public class ModernizaciaOSParametryOb2ekta {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.ModernizaciaOS part;
