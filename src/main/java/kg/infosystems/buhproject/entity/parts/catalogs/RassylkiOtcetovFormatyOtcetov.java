...
@JmixEntity
@Entity
@Table(name = "RassylkiOtcetovFormatyOtcetov", schema = "parts_catalogs")
@Getter
@Setter
public class RassylkiOtcetovFormatyOtcetov {
    ...
    private kg.infosystems.buhproject.entity.enumerations.FormatySohraneniaOtcetov format;
