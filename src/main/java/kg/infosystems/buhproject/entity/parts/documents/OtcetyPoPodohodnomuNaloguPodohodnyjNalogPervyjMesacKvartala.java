...
@JmixEntity
@Entity
@Table(name = "OtcetyPoPodohodnomuNaloguPodohodnyjNalogPervyjMesacKvartala", schema = "parts_documents")
@Getter
@Setter
public class OtcetyPoPodohodnomuNaloguPodohodnyjNalogPervyjMesacKvartala {
