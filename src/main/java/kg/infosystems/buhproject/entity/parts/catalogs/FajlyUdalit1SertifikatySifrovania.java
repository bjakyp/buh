...
@JmixEntity
@Entity
@Table(name = "FajlyUdalit1SertifikatySifrovania", schema = "parts_catalogs")
@Getter
@Setter
public class FajlyUdalit1SertifikatySifrovania {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.catalogs.Fajly part;
