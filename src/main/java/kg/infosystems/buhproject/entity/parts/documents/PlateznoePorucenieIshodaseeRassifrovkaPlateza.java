...
@JmixEntity
@Entity
@Table(name = "PlateznoePorucenieIshodaseeRassifrovkaPlateza", schema = "parts_documents")
@Getter
@Setter
public class PlateznoePorucenieIshodaseeRassifrovkaPlateza {
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "PART_ID")
	private kg.infosystems.buhproject.entity.documents.PlateznoePorucenieIshodasee part;
	...
	private kg.infosystems.buhproject.entity.one.Multiple bankovskijScet;
