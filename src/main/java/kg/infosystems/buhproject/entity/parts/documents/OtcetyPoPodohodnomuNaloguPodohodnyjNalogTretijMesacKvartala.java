...
@JmixEntity
@Entity
@Table(name = "OtcetyPoPodohodnomuNaloguPodohodnyjNalogTretijMesacKvartala", schema = "parts_documents")
@Getter
@Setter
public class OtcetyPoPodohodnomuNaloguPodohodnyjNalogTretijMesacKvartala {
