...
@JmixEntity
@Entity
@Table(name = "UderzanieZaPeriodUderzania", schema = "parts_documents")
@Getter
@Setter
public class UderzanieZaPeriodUderzania {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "PART_ID")
    private kg.infosystems.buhproject.entity.documents.UderzanieZaPeriod part;
