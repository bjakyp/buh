...
@JmixEntity
@Entity
@Table(name = "IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajlyUdalit1ElektronnyePodpisi", schema = "parts_catalogs")
@Getter
@Setter
public class IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajlyUdalit1ElektronnyePodpisi {
