...
@JmixEntity
@Entity
@Table(name = "PodrazdeleniaOrganizacij", schema = "catalogs")
@Getter
@Setter
public class PodrazdeleniaOrganizacij {
    ...
    private kg.infosystems.buhproject.entity.catalogs.PodrazdeleniaOrganizacij roditel1;
