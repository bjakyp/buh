...
import kg.infosystems.buhproject.entity.parts.catalogs.IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajlyUdalit1ElektronnyePodpisi;
import kg.infosystems.buhproject.entity.parts.catalogs.IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajlyUdalit1SertifikatySifrovania;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajly", schema = "catalogs")
@Getter
@Setter
public class IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajly {
    ...
    private kg.infosystems.buhproject.entity.catalogs.IstoriaProverkiIKorrektirovkiDannyh vladelecFajla;
	...
	private List<IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajlyUdalit1ElektronnyePodpisi> udalit1ElektronnyePodpisi;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<IstoriaProverkiIKorrektirovkiDannyhPrisoedinennyeFajlyUdalit1SertifikatySifrovania> udalit1SertifikatySifrovania;
}
