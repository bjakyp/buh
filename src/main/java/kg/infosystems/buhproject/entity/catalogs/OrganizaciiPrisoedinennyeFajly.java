...
import kg.infosystems.buhproject.entity.parts.catalogs.OrganizaciiPrisoedinennyeFajlyElektronnyePodpisi;
import kg.infosystems.buhproject.entity.parts.catalogs.OrganizaciiPrisoedinennyeFajlySertifikatySifrovania;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "OrganizaciiPrisoedinennyeFajly", schema = "catalogs")
@Getter
@Setter
public class OrganizaciiPrisoedinennyeFajly {
    ...
    private kg.infosystems.buhproject.entity.catalogs.Organizacii vladelecFajla;
	...
	private List<OrganizaciiPrisoedinennyeFajlyElektronnyePodpisi> elektronnyePodpisi;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<OrganizaciiPrisoedinennyeFajlySertifikatySifrovania> sertifikatySifrovania;
}
