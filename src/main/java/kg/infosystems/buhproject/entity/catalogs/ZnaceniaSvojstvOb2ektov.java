...
import kg.infosystems.buhproject.entity.parts.catalogs.ZnaceniaSvojstvOb2ektovPredstavlenia;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "ZnaceniaSvojstvOb2ektov", schema = "catalogs")
@Getter
@Setter
public class ZnaceniaSvojstvOb2ektov {
    ...
    private kg.infosystems.buhproject.entity.catalogs.ZnaceniaSvojstvOb2ektov roditel1;
	...
	private List<ZnaceniaSvojstvOb2ektovPredstavlenia> predstavlenia;
}
