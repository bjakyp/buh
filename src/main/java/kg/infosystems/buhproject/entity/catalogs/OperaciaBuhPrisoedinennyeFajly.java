...
import kg.infosystems.buhproject.entity.parts.catalogs.OperaciaBuhPrisoedinennyeFajlyElektronnyePodpisi;
import kg.infosystems.buhproject.entity.parts.catalogs.OperaciaBuhPrisoedinennyeFajlySertifikatySifrovania;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "OperaciaBuhPrisoedinennyeFajly", schema = "catalogs")
@Getter
@Setter
public class OperaciaBuhPrisoedinennyeFajly {
    ...
    private kg.infosystems.buhproject.entity.documents.OperaciaBuh vladelecFajla;
	...
	private List<OperaciaBuhPrisoedinennyeFajlyElektronnyePodpisi> elektronnyePodpisi;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<OperaciaBuhPrisoedinennyeFajlySertifikatySifrovania> sertifikatySifrovania;
}
