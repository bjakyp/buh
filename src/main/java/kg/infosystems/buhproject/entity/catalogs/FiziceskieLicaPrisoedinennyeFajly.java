...
import kg.infosystems.buhproject.entity.parts.catalogs.FiziceskieLicaPrisoedinennyeFajlyElektronnyePodpisi;
import kg.infosystems.buhproject.entity.parts.catalogs.FiziceskieLicaPrisoedinennyeFajlySertifikatySifrovania;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "FiziceskieLicaPrisoedinennyeFajly", schema = "catalogs")
@Getter
@Setter
public class FiziceskieLicaPrisoedinennyeFajly {
    ...
    private kg.infosystems.buhproject.entity.catalogs.FiziceskieLica vladelecFajla;
	...
	private List<FiziceskieLicaPrisoedinennyeFajlyElektronnyePodpisi> elektronnyePodpisi;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<FiziceskieLicaPrisoedinennyeFajlySertifikatySifrovania> sertifikatySifrovania;
}
