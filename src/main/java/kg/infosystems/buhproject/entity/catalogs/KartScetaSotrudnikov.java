...
@JmixEntity
@Entity
@Table(name = "KartScetaSotrudnikov", schema = "catalogs")
@Getter
@Setter
public class KartScetaSotrudnikov {
	...
	private kg.infosystems.buhproject.entity.catalogs.FiziceskieLica vladelec;
	...
	@Column(name = "NOMER_SCETA", length = 20)
	private String nomerSceta;

	@Column(name = "V_ARHIVE")
	private Boolean vArhive;
