...
import kg.infosystems.buhproject.entity.parts.catalogs.PredopredelennyeVariantyOtcetovPredstavlenia;
import kg.infosystems.buhproject.entity.parts.catalogs.PredopredelennyeVariantyOtcetovRazmesenie;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "PredopredelennyeVariantyOtcetov", schema = "catalogs")
@Getter
@Setter
public class PredopredelennyeVariantyOtcetov {
    ...
    private kg.infosystems.buhproject.entity.catalogs.PredopredelennyeVariantyOtcetov roditel1;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "OTCET_ID")
    private kg.infosystems.buhproject.entity.catalogs.IdentifikatoryOb2ektovMetadannyh otcet;
	...
	private List<PredopredelennyeVariantyOtcetovRazmesenie> razmesenie;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<PredopredelennyeVariantyOtcetovPredstavlenia> predstavlenia;
}
