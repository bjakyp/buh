...
@JmixEntity
@Entity(name = "informations_RazreseniaNaIspol1zovanieVnesnihResursovOblastejDannyh")
@Table(name = "RazreseniaNaIspol1zovanieVnesnihResursovOblastejDannyhIr", schema = "informations")
@Getter
@Setter
public class RazreseniaNaIspol1zovanieVnesnihResursovOblastejDannyh extends BaseEntity {
