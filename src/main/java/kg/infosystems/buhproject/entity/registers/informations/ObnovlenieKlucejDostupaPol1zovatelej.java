...
@JmixEntity
@Entity(name = "informations_ObnovlenieKlucejDostupaPol1zovatelej")
@Table(name = "ObnovlenieKlucejDostupaPol1zovatelejIr", schema = "informations")
@Getter
@Setter
public class ObnovlenieKlucejDostupaPol1zovatelej extends BaseEntity {
