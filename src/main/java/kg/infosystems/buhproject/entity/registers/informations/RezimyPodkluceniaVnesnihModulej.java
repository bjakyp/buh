...
@JmixEntity
@Entity(name = "informations_RezimyPodkluceniaVnesnihModulej")
@Table(name = "RezimyPodkluceniaVnesnihModulejIr", schema = "informations")
@Getter
@Setter
public class RezimyPodkluceniaVnesnihModulej extends BaseEntity {
