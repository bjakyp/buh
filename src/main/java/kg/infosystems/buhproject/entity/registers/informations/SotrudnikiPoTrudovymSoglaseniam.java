...
@JmixEntity
@Entity(name = "informations_SotrudnikiPoTrudovymSoglaseniam")
@Table(name = "SotrudnikiPoTrudovymSoglaseniamIr", schema = "informations")
@Getter
@Setter
public class SotrudnikiPoTrudovymSoglaseniam extends BaseEntity {
