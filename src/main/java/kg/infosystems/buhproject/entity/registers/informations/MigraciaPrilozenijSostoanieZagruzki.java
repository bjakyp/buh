...
@JmixEntity
@Entity(name = "informations_MigraciaPrilozenijSostoanieZagruzki")
@Table(name = "MigraciaPrilozenijSostoanieZagruzkiIr", schema = "informations")
@Getter
@Setter
public class MigraciaPrilozenijSostoanieZagruzki extends BaseEntity {
