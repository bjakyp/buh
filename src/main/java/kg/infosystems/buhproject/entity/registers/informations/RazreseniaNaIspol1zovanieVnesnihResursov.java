...
@JmixEntity
@Entity(name = "informations_RazreseniaNaIspol1zovanieVnesnihResursov")
@Table(name = "RazreseniaNaIspol1zovanieVnesnihResursovIr", schema = "informations")
@Getter
@Setter
public class RazreseniaNaIspol1zovanieVnesnihResursov extends BaseEntity {
	...
	@Lob
	@Column(name = "DOPOLNENIE_RAZRESENIA")
    private String dopolnenieRazresenia;
