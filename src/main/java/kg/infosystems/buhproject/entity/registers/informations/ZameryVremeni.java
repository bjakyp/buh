...
@JmixEntity
@Entity(name = "informations_ZameryVremeni")
@Table(name = "ZameryVremeniIr", schema = "informations")
@Getter
@Setter
public class ZameryVremeni extends BaseEntity {
    ...
    @Column(name = "VYPOLNEN_S_OSIBKOJ")
    private Boolean vypolnenSOsibkoj;
