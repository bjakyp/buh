...
@JmixEntity
@Entity(name = "informations_PostavlaemyeMaketyPecati")
@Table(name = "PostavlaemyeMaketyPecatiIr", schema = "informations")
@Getter
@Setter
public class PostavlaemyeMaketyPecati extends BaseEntity {
