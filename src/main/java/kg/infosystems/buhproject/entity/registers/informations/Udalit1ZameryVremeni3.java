...
@JmixEntity
@Entity(name = "informations_Udalit1ZameryVremeni3")
@Table(name = "Udalit1ZameryVremeni3Ir", schema = "informations")
@Getter
@Setter
public class Udalit1ZameryVremeni3 extends BaseEntity {
