...
@JmixEntity
@Entity(name = "informations_MigraciaPrilozenijSostoanieVygruzki")
@Table(name = "MigraciaPrilozenijSostoanieVygruzkiIr", schema = "informations")
@Getter
@Setter
public class MigraciaPrilozenijSostoanieVygruzki extends BaseEntity {
	...
	@JoinColumn(name = "VYGRUZAT1_NASTROJKI_POL1ZOVATELEJ_ID")
    private kg.infosystems.buhproject.entity.one.ValueStorage vygruzat1NastrojkiPol1zovatelej;

	@Column(name = "ZAVERSIT1_MIGRACIU_AVTOMATICESKI")
    private Boolean zaversit1MigraciuAvtomaticeski;
