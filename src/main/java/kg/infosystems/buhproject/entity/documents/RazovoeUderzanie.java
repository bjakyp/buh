...
@JmixEntity
@Entity
@Table(name = "RazovoeUderzanie", schema = "documents")
@Getter
@Setter
public class RazovoeUderzanie {
	...
	@Column(name = "VID_UDERZANIA_V_SPISKE")
	private Boolean vidUderzaniaVSpiske;
	...
	private List<RazovoeUderzanieUderzania> uderzania;
