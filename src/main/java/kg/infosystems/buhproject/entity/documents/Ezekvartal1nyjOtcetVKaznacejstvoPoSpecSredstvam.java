...
import kg.infosystems.buhproject.entity.parts.documents.Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvamDohody;
import kg.infosystems.buhproject.entity.parts.documents.Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvamRashody;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvam", schema = "documents")
@Getter
@Setter
public class Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvam {
	...
	private List<Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvamRashody> rashody;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<Ezekvartal1nyjOtcetVKaznacejstvoPoSpecSredstvamDohody> dohody;
}
