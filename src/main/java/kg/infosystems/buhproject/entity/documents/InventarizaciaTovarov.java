...
@JmixEntity
@Entity
@Table(name = "InventarizaciaTovarov", schema = "documents")
@Getter
@Setter
public class InventarizaciaTovarov {
	...
	private List<InventarizaciaTovarovTovary> tovary;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<InventarizaciaTovarovKomissia> komissia;
}
