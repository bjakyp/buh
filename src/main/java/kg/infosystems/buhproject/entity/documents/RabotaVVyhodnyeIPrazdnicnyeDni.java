...
@JmixEntity
@Entity
@Table(name = "RabotaVVyhodnyeIPrazdnicnyeDni", schema = "documents")
@Getter
@Setter
public class RabotaVVyhodnyeIPrazdnicnyeDni {
    ...
    private List<RabotaVVyhodnyeIPrazdnicnyeDniSotrudniki> sotrudniki;
