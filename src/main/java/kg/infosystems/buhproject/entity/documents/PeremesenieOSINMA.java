...
@JmixEntity
@Entity
@Table(name = "PeremesenieOSINMA", schema = "documents")
@Getter
@Setter
public class PeremesenieOSINMA {
	...
	private List<PeremesenieOSINMAOS> os;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<PeremesenieOSINMANMA> nma;
}
