...
@JmixEntity
@Entity
@Table(name = "Uvol1nenie", schema = "documents")
@Getter
@Setter
public class Uvol1nenie {
    ...
    @NotNull
    @Column(name = "DATA_UVOL1NENIA", nullable = false)
    private LocalDateTime dataUvol1nenia;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "OSNOVANIE_UVOL1NENIA_ID")
    private kg.infosystems.buhproject.entity.catalogs.OsnovaniaUvol1neniaIzOrganizacii osnovanieUvol1nenia;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "STAT1A_TRUDOVOGO_KODEKSA_ID")
    private kg.infosystems.buhproject.entity.catalogs.Stat1iTrudovogoKodeksa stat1aTrudovogoKodeksa;
    ...
    private kg.infosystems.buhproject.entity.registers.informations.Sotrudniki registerSotrudnika;

    @OneToMany(mappedBy = "uvol1nenie")
