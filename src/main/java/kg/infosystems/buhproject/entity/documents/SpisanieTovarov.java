...
@JmixEntity
@Entity
@Table(name = "SpisanieTovarov", schema = "documents")
@Getter
@Setter
public class SpisanieTovarov {
	...
	private kg.infosystems.buhproject.entity.documents.InventarizaciaTovarov dokumentOsnovanie;
	...
	private List<SpisanieTovarovTovary> tovary;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<SpisanieTovarovKomissia> komissia;
}
