...
@JmixEntity
@Entity
@Table(name = "DvizenieMBP", schema = "documents")
@Getter
@Setter
public class DvizenieMBP {
	...
	private kg.infosystems.buhproject.entity.enumerations.VidyOperacijDvizenieMBP vidOperacii;
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "SKLAD_POLUCATEL1_ID")
	private kg.infosystems.buhproject.entity.catalogs.Sklady skladPolucatel1;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "SOBYTIE_ID")
	private kg.infosystems.buhproject.entity.catalogs.SobytiaSTovarami sobytie;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "DOKUMENT_OSNOVANIE_ID")
	private kg.infosystems.buhproject.entity.documents.InventarizaciaMBP dokumentOsnovanie;
	...
	private List<DvizenieMBPMBP> mbp;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<DvizenieMBPKomissia> komissia;
}
