...
@JmixEntity
@Entity
@Table(name = "InventarizaciaOS", schema = "documents")
@Getter
@Setter
public class InventarizaciaOS {
	...
	@Column(name = "OSNOVANIE", length = 200)
	...
	@JoinColumn(name = "PROVERAUSIJ_ID")
	private kg.infosystems.buhproject.entity.catalogs.FiziceskieLica proverausij;
	...
	private List<InventarizaciaOSOS> os;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<InventarizaciaOSKomissia> komissia;
}
