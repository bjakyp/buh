...
@JmixEntity
@Entity
@Table(name = "InventarizaciaMBP", schema = "documents")
@Getter
@Setter
public class InventarizaciaMBP {
	...
	private List<InventarizaciaMBPMBP> mbp;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<InventarizaciaMBPKomissia> komissia;
}
