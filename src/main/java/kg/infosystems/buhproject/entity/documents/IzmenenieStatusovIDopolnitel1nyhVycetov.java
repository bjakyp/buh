...
@JmixEntity
@Entity
@Table(name = "IzmenenieStatusovIDopolnitel1nyhVycetov", schema = "documents")
@Getter
@Setter
public class IzmenenieStatusovIDopolnitel1nyhVycetov {
	...
	private List<IzmenenieStatusovIDopolnitel1nyhVycetovSotrudniki> sotrudniki;
