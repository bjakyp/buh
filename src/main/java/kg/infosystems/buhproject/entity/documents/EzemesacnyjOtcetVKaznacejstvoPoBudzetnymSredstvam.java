...
import kg.infosystems.buhproject.entity.parts.documents.EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvamBudzetnyeRashody;
import lombok.*;
...
@JmixEntity
@Entity
@Table(name = "EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvam", schema = "documents")
@Getter
@Setter
public class EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvam {
	...
	@Column(name = "SKRYT1_KOLONKU_FINANSIROVANIE_ZA_PREDYDUSIJ_PERIOD")
    private Boolean skryt1KolonkuFinansirovanieZaPredydusijPeriod;
	...
	private List<EzemesacnyjOtcetVKaznacejstvoPoBudzetnymSredstvamBudzetnyeRashody> budzetnyeRashody;
}
