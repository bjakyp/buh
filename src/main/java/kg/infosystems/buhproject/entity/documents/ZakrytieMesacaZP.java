...
import kg.infosystems.buhproject.entity.parts.documents.ZakrytieMesacaZPDannyePoVidamFinansirovania;
...
@JmixEntity
@Entity
@Table(name = "ZakrytieMesacaZP", schema = "documents")
@Getter
@Setter
public class ZakrytieMesacaZP {
	...
	private List<ZakrytieMesacaZPNalogiPoZarplate> nalogiPoZarplate;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<ZakrytieMesacaZPUderzania> uderzania;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<ZakrytieMesacaZPProvodki> provodki;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<ZakrytieMesacaZPDannyePoVidamFinansirovania> dannyePoVidamFinansirovania;
