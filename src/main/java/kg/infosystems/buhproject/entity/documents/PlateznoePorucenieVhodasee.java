...
@JmixEntity
@Entity
@Table(name = "PlateznoePorucenieVhodasee", schema = "documents")
@Getter
@Setter
public class PlateznoePorucenieVhodasee {
	...
	private kg.infosystems.buhproject.entity.catalogs.VidyOperacijPPV vidOperacii;
	...
	@Column(name = "VHODASIJ_NOMER", length = 100)
	private String vhodasijNomer;
	...
	@NotNull
	@ManyToOne(fetch = FetchType.LAZY, optional = false)
	@JoinColumn(name = "SCET_DT_ID", nullable = false)
	private kg.infosystems.buhproject.entity.accounts.Hozrascetnyj scetDt;

	@NotNull
	@ManyToOne(fetch = FetchType.LAZY, optional = false)
	@JoinColumn(name = "SCET_KT_ID", nullable = false)
	...
	private List<PlateznoePorucenieVhodaseeRassifrovkaPlateza> rassifrovkaPlateza;
}
