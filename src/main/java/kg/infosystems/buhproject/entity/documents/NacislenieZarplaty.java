...
@JmixEntity
@Entity
@Table(name = "NacislenieZarplaty", schema = "documents")
@Getter
@Setter
public class NacislenieZarplaty {
    ...
    @Column(name = "RAZOVOE_NACISLENIE")
    private Boolean razovoeNacislenie;
    ...
    private List<kg.infosystems.buhproject.entity.parts.documents.NacislenieZarplatyNacislenia> nacislenia;

    @OnDelete(DeletePolicy.CASCADE)
    @Composition
    @OneToMany(mappedBy = "nacislenieZarplaty")
    private List<kg.infosystems.buhproject.entity.documents.NacisleniyaIUderjaniya> nacisleniaIUderjania;
