...
@JmixEntity
@Entity
@Table(name = "VozvratOSINMAPostavsiku", schema = "documents")
@Getter
@Setter
public class VozvratOSINMAPostavsiku {
	...
	private List<VozvratOSINMAPostavsikuOS> os;

	@OnDelete(DeletePolicy.CASCADE)
	@Composition
	@OrderBy("nomerStroki")
	@OneToMany(mappedBy = "part")
	private List<VozvratOSINMAPostavsikuNMA> nma;
}
